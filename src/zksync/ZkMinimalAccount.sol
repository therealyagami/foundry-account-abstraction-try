 ...
 * msg.sender is always the bootloader system contract (kinda like a super admin or entryPoint contract on ethereum)
 *
 *
 *
 * Phase 1: Validation
 * 1. User sends the tx to the zkSync API client aka Node (sort of a light node)
